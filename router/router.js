...
import { getChatHistory, verifyChatAccess, getChats, markMessagesAsRead } from "../controllers/chatController.js"
...
router.post('/mark-message-as-read', markMessagesAsRead);
